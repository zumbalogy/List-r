...
thoughts on routing?:
    / is home
    /list/:listname is where your list be
    /new make new list (post here to create and send you to listname)
    /:listname/item fill in title, post here and sends you to next one:
    /:listname/item/submit here you will post to the next one
    /:listname/item/create and that redirects you back to /:listname
